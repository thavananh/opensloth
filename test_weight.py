...
def ensure_close_weight(dict1: Dict[str, torch.Tensor], dict2: Dict[str, torch.Tensor]) -> None:
...
def compare_weights(output_dir: str, gpu_ids: Tuple[int, ...], steps: Tuple[int, ...]) -> None:
